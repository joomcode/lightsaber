...
package test_case_projects.sanity.static_method_injection
...
class AppMain {
  companion object {
    ...
    @JvmStatic
    @Inject
    fun staticMethodWithInjection(dependency: Dependency) = Unit
  }

  fun run() {
    Lightsaber.Builder().build().createContract(AppContractConfiguration())
  }
}
