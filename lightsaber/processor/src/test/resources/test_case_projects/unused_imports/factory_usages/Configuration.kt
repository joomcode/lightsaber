...
package test_case_projects.unused_imports.factory_usages
...
interface MainContract {
  val mainDependencyFactory: MainDependencyFactory
}
...
interface MainDependencyFactory {
  @Factory.Return(MainDependencyImpl::class)
  fun create(): MainDependency
}

class MainDependencyImpl @Factory.Inject constructor(
  val secondaryDependency: SecondaryDependency,
) : MainDependency
