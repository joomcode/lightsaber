...
package test_case_projects.usage_validator.referencing_dependency_project
...
class ReferencingDependencyProjectContractConfiguration(@Import @Contract val dependencyProjectContract: DependencyProjectContract) :
  ContractConfiguration<ReferencingDependencyProjectContract>()
