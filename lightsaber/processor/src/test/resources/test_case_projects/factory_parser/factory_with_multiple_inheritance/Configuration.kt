...
package test_case_projects.factory_parser.factory_with_multiple_inheritance
...
@ProvidedAs(FooFactory::class, BarFactory::class)
interface CompositeFactoryImpl : FooFactory, BarFactory {
